...
";
            ...
            var PassportFileTest = @"ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
";
            ...
            var PassportFileTest = @"pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:#623a2f
...
iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719";
            ...
            var ValidPasports = from x in PassportDicts
                                where ((x.Count() == 7 && x.Where(y => y.Key == "cid").Any() == false) ^ x.Count() == 8) && x.Where(y => y.Validity == false).Any() == false
                                select x;
